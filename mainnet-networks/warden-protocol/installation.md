...
```
wardend init MyNode --chain-id warden_8765-1
```

### Download genesis and addrbook

<pre><code><strong>curl -Ls https://snapshots.aknodes.net/snapshots/warden-mainnet/genesis.json > $HOME/.warden/config/genesis.json
</strong></code></pre>

```
curl -Ls https://snapshots.aknodes.net/snapshots/warden-mainnet/addrbook.json > $HOME/.warden/config/addrbook.json
```
